...
<div class="container" style="margin-left:93px; margin-bottom:10%;padding-left:130px; box-shadow: 2px 2px 10px #1b93e1; border-radius: 4px; top: 14px; padding-top: 3%;">
    ...
    <div class="row" style="margin-top: 5%;">
     <div class="col-md-3" style="text-align:right">
      ...
      <div class="col-md-6">
        <input type="text" class="form-control" name="txt_studentname" style="width:500px;" placeholder="Enter institution name">
      </div>
    </div>
    <br>
    <div class="row">
     ...
     <label>PLACE OF INSTITUTION:</label>
      ...
      <div class="col-md-6">
        <input type="text" class="form-control" name="txt_studentname" style="width:500px;" placeholder="Enter place of institution">
      </div>
    </div>
    <br>
    <div class="row">
     <div class="col-md-3" style="text-align:right">
      ...
      <div class="col-md-6">
        <input type="text" class="form-control" name="txt_email" style="width:500px;" placeholder="Enter state of institution" required>
      </div>
    </div>
    <br>
    <div class="row">
      ...
      <div class="col-md-6">
        <input type="DATE" name="contact" title="ten digit cods" class="form-control" required ">
      </div>
    </div>
    <br>
    <div class="row">
     <div class="col-md-3" style="text-align:right">
      ...
      <div class="col-md-6">
       <input type="text" class="form-control" name="txt_username" style="width:500px;" placeholder="enter mark in percentage" required>
      </div>
    </div>
    <br>
    <br>
    <div class="row">
     <div class="col-md-3" style="text-align:right">
      ...
      <div class="col-md-6">
       <input type="text" class="form-control" name="txt_username" style="width:500px;" placeholder=" number no. of attempts" required>
      </div>
    </div>
    <br>
