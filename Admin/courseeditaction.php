...
$Entercoursetype=$_POST["txtcoursetype"];
$save=mysqli_query($con,"update tbl_course set coursename='$Entercoursename',courseshortname='$Entershortname', coursetype='$Entercoursetype' where courseid='$courseid'");
