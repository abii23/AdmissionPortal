...
$save=mysqli_query($con,"insert into  tbl_degree(stream,universityname,institutionname,institutionplace,institutionstate,passoutyear,aggregatescore,applicationnumber)
values('$Enterdegreestream','$Enteruniversityname','$Enterdegreeinstitutionname','$Enterdegreeinstitutionplace','$Enterdegreeinstitutionstate','$Enterdegreeyear','$Enterdegreemark','$applicationnumber')");
...
if($save)
{
    ...
    echo "<script>alert('UG DETAILS COMPLETED!!!'); window.location='index.php'</script>";
}
else
{
