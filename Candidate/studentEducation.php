...
<br>
    <div class="row">
     <div class="col-md-3" style="text-align:right">
      ...
      <div class="col-md-6">
       <input type="text" class="form-control" name="txt_10Board" style="width:500px;" placeholder="enter Board of Examination" required>
      </div>
    </div>
    <br>
    <div class="row">
    ...
    <div class="row">
     <div class="col-md-3" style="text-align:right">
      ...
      <div class="col-md-6">
       <input type="text" class="form-control" name="txt_12Board" style="width:500px;" placeholder="enter Board of Examination" required>
      </div>
    </div>
