...
$row=mysqli_query($con,"select * from tbl_candidatebasicdetails where applicationnumber='$appno'");
...
<div class="container" style="margin-left:93px; margin-bottom:10%;padding-left:130px; box-shadow: 2px 2px 10px #1b93e1; border-radius: 4px; top: 14px; padding-top: 3%;">
    ...
    <div class="row">
     <div class="col-md-3" style="text-align:right">
      ...
      <div class="col-md-6">
        <input type="text" class="form-control" name="txt_fathername" style="width:500px;" placeholder="Enter Father Name" >
      </div>
    </div>
    <br>
    <div class="row">
     <div class="col-md-3" style="text-align:right">
      ...
      <div class="col-md-6">
        <input type="text" class="form-control" name="txt_mothername" style="width:500px;" placeholder="Enter Mother Name">
      </div>
    </div>
    <br>
    ...
    <div class="row">
     <div class="col-md-3" style="text-align:right">
      ...
      <div class="col-md-6">
        <input type="text" class="form-control" name="txt_fatheroccupation" style="width:500px;" placeholder="Enter the father occupation">
      </div>
    </div>
    <br>
    <div class="row">
     <div class="col-md-3" style="text-align:right">
      ...
      <div class="col-md-6">
        <input type="text" class="form-control" name="txt_motheroccupation" style="width:500px;" placeholder="Enter the mother occupation">
      </div>
    </div>
    <br>
