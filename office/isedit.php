        ...
        <table class="table table-hover" style="border: 2px solid #adaaaa; box-shadow: 3px 3px 11px #777777; margin-bottom:7%">
          ...
          <?php
            ...
            $courseid=$_POST['coursewise'];
              ...
              ?>
            <td><a href="lock.php?applicationnumber=<?php echo $row['applicationnumber'];?>" class="glyphicon glyphicon-trash" >Lock</a></td>
            ...
            <td><a href="unlock.php?applicationnumber=<?php echo $row['applicationnumber'];?>" class="glyphicon glyphicon-trash" >Unlock</a></td>
