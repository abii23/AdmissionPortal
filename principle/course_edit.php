...
// echo $courseCriteria; exit;
$seatcapp=$row["seat_cappacity"];
// echo $seatcapp; exit;
?>
<html>
<body>
<form method="POST" action="courseeditaction.php">
 <div class="container" style="margin-left:93px; margin-bottom:3%;padding-left:130px; box-shadow: 2px 2px 10px #1b93e1; border-radius: 4px; top: 14px; margin-top: 0%;"><br>
    ...
    <div class="row">
      <div class="col-md-3" style="text-align:right">
        <label >Seat cappacity</label>
      </div>
      <br>
      <div class="col-md-3">
        <input type="text" name="txt_seat" class="form-control" style="width:500px;" placeholder="Enter shortname" value="<?php echo $seatcapp;?>" required>
      </div>
     </div>
     <div class="row">
