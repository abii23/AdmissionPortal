...
<form method="POST" action="courseaction.php">
 <div class="container" style="margin: left 110px; margin-bottom:3%;padding-left:130px; box-shadow: 2px 2px 10px #1b93e1; border-radius: 4px; top: 14px; margin-top: 5%;"><br>
    ...
    <div class="row">
      ...
      <div class="col-md-3">
        <input type="text"   name="txt_shortname" class="form-control" style="width:500px;" placeholder="Enter shortname" required/>
      </div>
    </div>
    <div class="row">
    <div class="col-md-3" style="text-align:right">
    ...
    <div class="col-md-3" style="text-align:right">
      ...
      <div class="col-md-6">
      <textarea rows="10" cols="60" name="txtcriteria" >  </textarea>
    ...
    <div class="col-md-3" style="text-align:right">
      ...
      <div class="col-md-6">
        <input type="number" class="form-control" name="txt_seat" style="width:500px;" placeholder="Seats available" required>
      </div>
    </div>
    <br>
     <div class="row">
